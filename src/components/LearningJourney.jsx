...
export default function LearningJourney() {
  ...
  return (
    <section id="journey" className="py-20 relative bg-[#070a0f]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center space-y-3 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Learning <span className="text-[#00ff9d]">Journey</span>
          </h2>
        ...
        <div className="mb-16 p-4 sm:p-6 glass-card rounded-2xl border border-slate-800 overflow-x-auto">
              ...
              <React.Fragment key={idx}>
                <div className={`px-3 py-2 rounded-xl border text-xs font-mono flex items-center gap-2 ${
                  step.status === 'Completed'
                    ...
                    ? 'bg-cyan-950/80 border-cyan-400 text-cyan-300 shadow-cyber-cyan'
        ...
        <div className="relative border-l-2 border-slate-800/80 ml-4 sm:ml-8 pl-6 sm:pl-10 space-y-8">
            ...
            return (
              <div key={idx} className="relative group">
                ...
                <div className={`absolute -left-[31px] sm:-left-[47px] top-1.5 w-6 h-6 rounded-full border-2 flex items-center justify-center text-[10px] font-mono font-bold transition-transform group-hover:scale-125 ${
                  isCompleted
                    ? 'bg-emerald-950 border-[#00ff9d] text-[#00ff9d]'
                    : isActive
                ...
                <div className="glass-card rounded-2xl p-6 border border-slate-800/90 hover:border-slate-700 transition-all space-y-4">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-[#00ff9d]">
                  ...
                  {/* Highlights Grid */}
                  <div className="pt-2 border-t border-slate-800/60 grid grid-cols-2 sm:grid-cols-4 gap-2">
                    {item.highlights.map((hl, hIdx) => (
                      <div key={hIdx} className="p-2 rounded-lg bg-slate-900/60 border border-slate-800/80 text-[11px] font-mono text-slate-300 flex items-center gap-1.5">
